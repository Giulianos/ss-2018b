...
for i in range(0, n):
    if i == shown_particle:
        circle = shown_particle_circle = plt.Circle((particles[i][0], particles[i][1]), particles[i][2], color='green')
    elif i in adjacents:
...
ax.add_artist(shown_particle_circle)
